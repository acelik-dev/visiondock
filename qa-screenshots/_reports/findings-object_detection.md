...
- **[PASS]** `04-vlm-chat` — Copy present: 'Generate Config'
  - Observed exact string
  - Exact UI: `Generate Config`
- **[PASS]** `04-vlm-chat` — Copy present: 'Find several objects'
  - Observed exact string
  - Exact UI: `Find several objects`
...
- **[PASS]** `05-generate-config` — Copy present: 'Generate Config'
  - Observed exact string
  - Exact UI: `Generate Config`
- **[PASS]** `05-generate-config` — Copy present: 'Find several objects'
  - Observed exact string
  - Exact UI: `Find several objects`
...
- **[NOTE]** `05-generate-config` — Mixed dash styles (em dash and spaced hyphen)
  - Both '—' and ' - ' appear on page
- **[PASS]** `05-generate-config` — Task badge shows 'Find several objects'
  - Exact match
  - Exact UI: `Find several objects`
...
- **[PASS]** `06-dataset-step` — Copy present: 'Why a ZIP (not per-group photo upload)?'
  - Observed exact string
  - Exact UI: `Why a ZIP (not per-group photo upload)?`
- **[PASS]** `06-dataset-step` — Copy present: 'This task is object detection'
  - Observed exact string
  - Exact UI: `This task is object detection`
- **[PASS]** `06-dataset-step` — Copy present: 'Find several objects'
  - Observed exact string
  - Exact UI: `Find several objects`
...
- **[PASS]** `07-training-review` — Copy present: 'Find several objects'
  - Observed exact string
  - Exact UI: `Find several objects`
...
- **[PASS]** `08-ui-details` — Copy present: 'Start training'
  - Observed exact string
  - Exact UI: `Start training`
- **[PASS]** `08-ui-details` — Copy present: 'Find several objects'
  - Observed exact string
  - Exact UI: `Find several objects`
