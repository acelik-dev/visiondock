...
- **[PASS]** `05-generate-config` — Copy present: 'Generate Config'
  - Observed exact string
  - Exact UI: `Generate Config`
- **[PASS]** `05-generate-config` — Copy present: 'Find one object'
  - Observed exact string
  - Exact UI: `Find one object`
...
- **[NOTE]** `05-generate-config` — Mixed dash styles (em dash and spaced hyphen)
  - Both '—' and ' - ' appear on page
- **[PASS]** `05-generate-config` — Task badge shows 'Find one object'
  - Exact match
  - Exact UI: `Find one object`
...
- **[PASS]** `06-dataset-step` — Copy present: 'Find one object'
  - Observed exact string
  - Exact UI: `Find one object`
...
- **[PASS]** `07-training-review` — Copy present: 'Find one object'
  - Observed exact string
  - Exact UI: `Find one object`
...
- **[PASS]** `08-ui-details` — Copy present: 'Start training'
  - Observed exact string
  - Exact UI: `Start training`
- **[PASS]** `08-ui-details` — Copy present: 'Find one object'
  - Observed exact string
  - Exact UI: `Find one object`
